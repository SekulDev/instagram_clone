    ...
    <div class="flex flex-col items-center gap-2 sm:max-w-[11/12] md:w-[350px]">
        <Card class="w-[100%] p-6">
            <CardHeader class="p-5">
                <CardTitle class="text-center text-lg font-semibold">Zmiana hasła</CardTitle>
                <CardDescription class="text-center text-sm">
                    Wprowadź nowe hasło którym chcesz się logować do konta
                </CardDescription>
            </CardHeader>
            <CardContent class="pb-0">
                <form class="flex flex-col gap-2" @submit="onSubmit">
                    ...
                    <FormField v-slot="{ componentField }" name="password2">
                        <FormItem>
                            <FormControl>
                                <Input type="password" placeholder="Powtórz hasło" v-bind="componentField" />
                            </FormControl>
                        </FormItem>
                    </FormField>

                    <Button :disabled="disabled" class="mt-2" size="sm" type="submit">Zmień hasło</Button>

                    <div class="my-3 flex flex-col items-center">
                        <span v-if="errorMessage" class="text-destructive text-center text-sm font-thin">
                            Link do zmiany hasła jest nieaktywny
                        </span>
